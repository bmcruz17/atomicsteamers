# Google Business Profile — copy to paste

Use this in business.google.com (or the "Your business on Google" panel) →
**Edit profile**. Keep name/phone/website identical to the website (NAP).
...
## Secondary categories (add these too)
- Cleaning service
- Sanitation service
...
## Services to add (tap Services → add custom)
- Bed bug removal
- Bed bug treatment
...
- **Service area:** set to Oahu (and the towns above) if it's a service-area business.
- **Hours:** 7 days, 7am–7pm (match the website).
- After saving, ask 2–3 happy customers for a Google review.
