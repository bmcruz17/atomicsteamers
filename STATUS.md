...
> **Last updated:** <!--LAST_UPDATED-->2026-07-01<!--/LAST_UPDATED--> · auto-refreshed daily ~1am HST
...
| Domain registry status | ✅ active — registrar Squarespace Domains LLC · transfer pending |
...
- [ ] **Google Business Profile** (business.google.com) — category Pest Control
      Service, Oahu service area, real Optima photos, (808) 265-5339, hours, website,
...
- Site rebuilt: green theme, bed-bug focus, real phone ((808) 265-5339) + hello@ email,
...
<!--LOG-->
- **2026-07-01** — Auto health check. All monitored checks green.
